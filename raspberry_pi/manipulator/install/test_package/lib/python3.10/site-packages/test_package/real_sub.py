...
class TeleopSubscriber(Node):
    ...
    def GETSEE(self, msg):
            ...
            goal_kinematics_pose[0] = 0.235
            goal_kinematics_pose[1] = -0.016
            goal_kinematics_pose[2] = 0.107
            goal_kinematics_pose[3] = 0.949
            goal_kinematics_pose[4] = 0.011
            goal_kinematics_pose[5] = 0.313
            goal_kinematics_pose[6] = -0.034
            self.node.send_goal_task_space()
            time.sleep(2)
            goal_kinematics_pose[0] = 0.344
            goal_kinematics_pose[1] = -0.009
            goal_kinematics_pose[2] = -0.025
            goal_kinematics_pose[3] = 0.914
            goal_kinematics_pose[4] = 0.005
            goal_kinematics_pose[5] = 0.405
            goal_kinematics_pose[6] = -0.012
            self.node.send_goal_task_space()
            time.sleep(2)
            goal_kinematics_pose[0] = 0.198
            goal_kinematics_pose[1] = 0.001
    ...
    def UPARM(self, msg):
            ...
            self.node.send_goal_task_space()
            time.sleep(2)
            goal_kinematics_pose[0] = -0.113
            goal_kinematics_pose[1] = -0.068
            goal_kinematics_pose[2] = 0.256
            goal_kinematics_pose[3] = -0.246
            goal_kinematics_pose[4] = -0.036
            goal_kinematics_pose[5] = -0.009
            goal_kinematics_pose[6] = 0.969
            self.node.send_goal_task_space()
            time.sleep(2)
    ...
    def MOVEARM(self,msg):
            ...
            self.node.send_goal_task_space()
            time.sleep(2)
            goal_kinematics_pose[0] = -0.162
            goal_kinematics_pose[1] = 0.030
            goal_kinematics_pose[2] = 0.176
            goal_kinematics_pose[3] = 0.084
            goal_kinematics_pose[4] = -0.105
            goal_kinematics_pose[5] = 0.009
            goal_kinematics_pose[6] = 0.991
            self.node.send_goal_task_space()
            time.sleep(2)
    ...
    def TURNARM(self, msg):
            ...
            msg.data = "pushup"
            print(msg)
            msg_publisher = self.create_publisher(String, "pushup", 10)
            msg_publisher.publish(msg)
    ...
    def PUSHUP(self,msg):
            ...
            msg.data = "seeelvae"
            print(msg)
            msg_publisher = self.create_publisher(String, "seeelvae", 10)
            msg_publisher.publish(msg)
    ...
    def SEEELVAE(self, msg):
            ...
            msg.data = "move2arm"
            print(msg)
            msg_publisher = self.create_publisher(String, "move2arm", 10)
            msg_publisher.publish(msg)
    ...
    def TEST1(self, msg):
            ...
            self.node.open_manipulator_state_callback('STOPPED')
            time.sleep(4)
            goal_kinematics_pose[0] = present_kinematics_pose[0] + -0.055
            goal_kinematics_pose[1] = present_kinematics_pose[1] + 0.041
            goal_kinematics_pose[2] = present_kinematics_pose[2] + 0.025
            ...
            self.node.send_goal_task_space()
            time.sleep(2)
            # goal_kinematics_pose[0] = -0.168
            # goal_kinematics_pose[1] = 0.169
            # goal_kinematics_pose[2] = 0.159
            # goal_kinematics_pose[3] = 0.370
            # goal_kinematics_pose[4] = 0.009
            # goal_kinematics_pose[5] = -0.003
            # goal_kinematics_pose[6] = 0.930
            ...
            msg.data = "takein"
            print(msg)
            msg_publisher = self.create_publisher(String, "takein", 10)
            msg_publisher.publish(msg)
